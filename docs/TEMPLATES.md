...
Notes: 
- The term `OID` is abused as used to refer to any variable like the `target OID`, the `numeric OID`, the `index`: This is conveniant, but confusing as this is not the SNMP definition.   
