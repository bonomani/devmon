...
Alarm and error are propagated from source oids to targets oids. If the error flag set true, the threshold processing is bypassed and the error, the color and the message are just copyed to be propagated.
#### Connectivity error
